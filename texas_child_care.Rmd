...
# find percent of fully licensed centers providing child care in Feb. 1, 2020
# compare to percent of fully licensed centers providing child care as of Nov. 27, 2021
child_care_centers %>% 
...
# count number of new closures per week
child_care_centers %>% 
...
# chart number of fully licensed centers providing child care from January 2019 to November 2021
child_care_centers %>% 
  filter(Permit_Status == 'Full') %>% 
  group_by(Week) %>% 
  count(Operating_Status) %>% 
...
# chart number of fully licensed centers providing before/after school care from January 2019 to November 2021
before_after_schools %>% 
  group_by(Week) %>% 
  count(Operating_Status) %>% 
  filter(Operating_Status == 'Y') %>% 
