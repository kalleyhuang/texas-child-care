...
child_care %>% 
  count(COUNTY) %>% 
  arrange(COUNTY)
setdiff(toupper(children_by_county$county), child_care$COUNTY)
...
# calculate ratio of children under 5 to total capacity of centers caring as of Sept. 1, by county
child_care_operations_2021 %>% 
