...
# calculate ratio of children under 5 to total capacity of daycares, by county
daycare %>% 
...
# calculate ratio of children under 5 to total capacity of daycares open as of May 1, 2021, by county
daycare_operations_2021 %>% 
...
```{r daycare_output}
# to export spreadsheets of daycares "not caring"
...
# visualize number of daycares "not caring" from January 2021 to May 2021
daycare_operations_2021 %>% 
  filter(day(Week) == 1) %>% 
  group_by(Week) %>% 
  count(Status) %>% 
